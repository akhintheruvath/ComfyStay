    ...
    <div>
        <div className="container">
            <div className='flex gap-2 sm:gap-0 justify-between mt-6 mx-4 lg:px-5 sm:py-3 lg:py-4 overflow-x-auto lg:border lg:border-gray-300 rounded-lg'>
                ...
                <p className="font-bold text-md sm:text-xl hover:cursor-pointer px-1">Flat</p>
                ...
                <p className="font-bold text-md sm:text-xl hover:cursor-pointer px-1">Apartment</p>
